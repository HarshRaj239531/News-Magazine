...
@section('title', 'CONTACT US - VIGYANMEV JAYATE')
    ...
    <div class="page-banner">
        <div class="container">
            ...
            <div class="breadcrumb">
                <a href="{{ route('home') }}">Home</a> &raquo; <span>Contact Us</span>
            </div>
        </div>
    </div>
    ...
    <section style="padding: 60px 0;">
        <div class="container" style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: start;">
            ...
            <div class="sidebar-panel" style="padding: 40px;">
                <h2 style="font-size: 1.6rem; color: var(--primary-color); margin-bottom: 25px; border-bottom: 2px solid var(--accent-color); padding-bottom: 10px;">VIGYANMEV JAYATE HEAD OFFICE</h2>
                
                <div style="margin-bottom: 20px;">
                    <p style="font-weight: bold; color: var(--primary-color); font-size: 1rem; margin-bottom: 5px;">📍 Address / पता:</p>
                ...
                <div style="margin-bottom: 20px;">
                    <p style="font-weight: bold; color: var(--primary-color); font-size: 1rem; margin-bottom: 5px;">📧 Email Address / ईमेल:</p>
                    <p style="font-size: 0.9rem; color: #4a5568;"><a href="mailto:contact@vigyanmev.gov.in">contact@vigyanmev.gov.in</a></p>
                </div>

                <div style="margin-bottom: 20px;">
                    <p style="font-weight: bold; color: var(--primary-color); font-size: 1rem; margin-bottom: 5px;">📞 Phone / दूरभाष:</p>
                    <p style="font-size: 0.9rem; color: #4a5568;">+91-11-23091122, +91-11-23094455</p>
                </div>

                <div style="margin-bottom: 20px;">
                    <p style="font-weight: bold; color: var(--primary-color); font-size: 1rem; margin-bottom: 5px;">📜 Ministry Details / मंत्रालय विवरण:</p>
                    <p style="font-size: 0.9rem; color: #4a5568;">Registered under PRGI Ministry of Information and Broadcasting, Government of India.</p>
                </div>
            </div>

            <!-- Right Side: Contact Form -->
            <div class="payment-card" style="margin: 0; max-width: 100%;">
                <h2 style="font-size: 1.5rem; color: var(--primary-color); margin-bottom: 20px;">Send Us an Inquiry</h2>
                <p style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 25px;">Please fill out this form to submit your inquiry or feedback to our board editors.</p>
                ...
                <form action="#" method="POST" onsubmit="event.preventDefault(); alert('Thank you for contacting us! Your inquiry has been submitted.'); this.reset();">
                    ...
                    <button type="submit" class="btn-primary" style="width: 100%; padding: 12px; font-size: 0.95rem;">Send Message ✉</button>
                </form>
            </div>
